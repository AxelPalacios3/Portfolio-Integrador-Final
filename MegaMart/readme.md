...
- `cluster_analysis.ipynb` – Main notebook with all the code, clustering analysis and visualizations.  
- `megamart_customer_data.csv` – Dataset used in the analysis (customer-level behavioral data).  
...
| Resource           | Link |
|--------------------|------|
| Main notebook      | [`cluster_analysis.ipynb`](MegaMart.ipynb) |
| Dataset            | [`megamart_customer_data.csv`](retail_customer_data-1.csv) |
| Executive summary  | [`MEGAMART.pdf`](MEGAMART.pdf) |
